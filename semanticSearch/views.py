...
def search_booking(request):
    result = make_query("https://github.com/kaflesaurav/restbook/blob/master/booking_rdf.owl", request)
...
def search_menu_item(request):
    result = make_query("semanticSearch/static/booking_rdf.owl", request)
